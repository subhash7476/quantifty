...
| **V-0b** | Canonical 1m `NSE_INDEX|India VIX` (Upstox backfill, `fetch_upstox_historical.py`) | 2022-01-03 → 2026-09-11, 1,165 sessions / 435,244 rows | **NONE — unread** | — | no research consumer; written 2026-09-12 | Value-verified 99.98% exact vs the vendor CSV over 294,131 bars / 789 sessions. Carries defect V2 (90 sessions with bars past 15:30, 2022) — `VIX_1M_INGEST_VERIFICATION_2026-09-12.md` |
| **V-0c** | `data/market_data/India VIX Historical Data 101.csv` (vendor EOD) | 2010-01-04 → 2025-06-05, 3,822 rows | **NONE — unread** | — | no committed reader | Extends VIX daily back to 2010 (canonical 1d starts 2015). Overlap check **not run** |
