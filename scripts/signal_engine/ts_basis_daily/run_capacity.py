"""TS Basis Daily — Capacity Analysis.

Mirror of TS Basis run_capacity.py for daily cadence.
Sweeps AUM from 1 Cr to 100 Cr, measures ADV cap incidence.

Output: docs/reports/TS_BASIS_DAILY_CAPACITY_REPORT.md
"""
...
REPORT = ROOT / "docs" / "reports" / "TS_BASIS_DAILY_CAPACITY_REPORT.md"
...
def main():
    ...
    lines = []
    a = lines.append
    a("# TS Basis Daily — Capacity Analysis\n")
