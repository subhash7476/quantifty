...
3. **Margin depth (§8).** `MarginTracker` currently enforces a portfolio-aware flat-rate margin model. The remaining planned enhancement is SPAN integration (MM9.4).
