...
*45 Years* reading and recommends changes to §0 row D, §D.2 and §D.3 (per-date surrogate
differencing replaced by a Monte Carlo rank test), §D.4 (GF-7, GF-8 and GF-9 excluded from Stage 1), §E.4
