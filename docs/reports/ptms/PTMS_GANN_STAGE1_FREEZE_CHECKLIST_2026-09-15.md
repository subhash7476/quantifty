...
**Date:** 2026-09-15 · **Updated:** 2026-09-19 (GF-10 items: row 19; §4 OPEN-J / OPEN-6 / OPEN-11 / OPEN-12 added, then
...
| 9 | Placebo sets (GF-1, GF-4T/R8) and the GF-10 contrast | **GF-1 and GF-4T/R8 placebo families RULED — TO TRANSCRIBE** (G-3, 2026-09-15; GF-1 = 132-set exhaustive phase-shift orbit; GF-4T/R8 = 162-set rigid-translation family, d = 1…179 minus 17 centre-collision shifts); GF-10 contrast ruled in principle, contrast p **OPEN** (G-4) | Ruling register, G-3 blocks; G-4 | Research (transcribe) / Operator (G-4) |
...
| 19 | GF-10 mechanical definition complete (detector, ledger, legs, latches, P1–P4 populations, formal contrast, timestamps, weekly score, outcome) | **Largely LOCKED — TO TRANSCRIBE**: `GF10_MECHANICAL_DECISION_RECORD_v0.7_2026-09-19.md` records 62 locks, including OPEN-6, OPEN-11, OPEN-J and OPEN-12a–d (ruled 2026-09-19). Its audit is PASS with no contradiction, and the P1 event → O-R10 chain is coherent through OPEN-12. **OPEN — DEFINITION MISSING:** OPEN-K, OPEN-L, OPEN-M (v0.7 §5.3). GF-1 and GF-4T/R8 have no equivalent mechanical record; their cells transcribe from rows 2–5. **Ratification requested:** RR-1 (penetration strictness) and RR-2 (the literal "first penetrated"), v0.7 §5.3. **Item 2 caution:** transcribe GF-10's primary cell from v0.7 §11.2, not from R-5's sentence, because C-5, C-6, OD-4 and OPEN-11a supersede it | §4 OPEN-K, OPEN-L, OPEN-M; RR-1, RR-2 | Operator (rulings) / Research (transcribe) |
