...
| 15 | Exposure register row G-S1 appended **by the operator** before any read | **DONE 2026-09-19** — register §10, commit `cabaeba` (appended at the operator's explicit instruction), carrying the freeze digest; no read before it | P-4 | **Operator only** |
