...
**Script-generated** — `scripts/psb1/certify_substrate.py`. Code commit `a41d033`.
Real store, read-only. Store stamps: rows **7,154,268**, fenced MAX(trade_date) **2022-12-30**, unfenced MAX **2026-09-11**.
...
| Check | Result | Detail |
|---|:--:|---|
| **Arm A** intra-symbol CA-shape | **HALT** | 91 residue (76 dispositioned, **15** undocumented); 2739 large_genuine |
...
| **Arm D** factor evidence | **HALT** | 1114 tested, 17 flagged (0 dispositioned, **17** undocumented) |
...
| Structural: DVL->DTIL re-key | **FAIL** | DVL=1 DTIL=0 NONE |
...
91 CA-shaped moves with no matching factor. Dispositioned: 76. **Undocumented (HALT): 15**.
...
| CORDELIA | CORDELIA | 2026-08-25 | -90.0% | CA-shaped-orphan | **HALT** |
| DPL | DVL | 2021-08-05 | +40.2% | direction-mismatch | **HALT** |
| DSPGOLDETF | GOLDADD | 2026-08-28 | -90.0% | CA-shaped-orphan | **HALT** |
| DSPSILVETF | SILVERADD | 2026-08-28 | -89.8% | CA-shaped-orphan | **HALT** |
| GULFPETRO | SAHPETRO | 2013-07-09 | +81.6% | direction-mismatch | **HALT** |
| HOPFL | PGIL | 2026-09-11 | -50.1% | CA-shaped-orphan | **HALT** |
| INDIAGLYCO | INDIAGLYCO | 2026-09-02 | -78.8% | CA-shaped-orphan | **HALT** |
| IVZINNIFTY | IVZINNIFTY | 2026-07-31 | -89.9% | CA-shaped-orphan | **HALT** |
| JLHL | JLHL | 2026-07-24 | -79.5% | CA-shaped-orphan | **HALT** |
| KILITCH | KILITCH | 2012-09-24 | -39.9% | CA-shaped-orphan | **HALT** |
| KIRLPNU | KIRLPNU | 2026-08-18 | -50.5% | CA-shaped-orphan | **HALT** |
| KWALITY | KWALITY | 2010-06-15 | +45.9% | direction-mismatch | **HALT** |
| POCL | POCL | 2026-07-21 | -60.0% | CA-shaped-orphan | **HALT** |
| TCC | TCC | 2026-09-04 | -81.1% | CA-shaped-orphan | **HALT** |
| TDPOWERSYS | TDPOWERSYS | 2026-08-24 | -49.2% | CA-shaped-orphan | **HALT** |

Large genuine moves (|ret|>=40%, non-CA-shaped, not CA-explained): **2739** — disclosed for operator review, not HALT.
...
|--------|------|----|------|-------:|-------------|
| INDOSOLAR | INDOSOLAR | WAAREEINDO | 2025-06-19 | +16406.7% | relisting_after_suspension: INDOSOLAR (INE866K01015) -> WAAREEINDO; factor 100 applied; 1473 missed sessions |
| CLCIND | SPENTEX | CLCIND | 2026-01-30 | +1094.7% | relisting_after_suspension: SPENTEX (INE376C01020) -> CLCIND; factor 100 applied; 1343 missed sessions |
...
1114 factors with adjacent-session evidence tested. 17 flagged (0 dispositioned, **17** undocumented (HALT)).

| Symbol | Ex-date | Factor | Failure | Disposition |
|--------|---------|-------:|---------|-------------|
| AHLEAST | 2022-10-06 | 0.6667 | wrong_ratio | **HALT** |
| BIRLAPOWER | 2010-10-20 | 0.8333 | no_reprice | **HALT** |
| CUPID | 2018-10-11 | 0.8333 | no_reprice | **HALT** |
| DVL | 2021-08-05 | 0.6667 | no_reprice+wrong_ratio | **HALT** |
| GMBREW | 2018-05-21 | 0.8000 | no_reprice | **HALT** |
| IGARASHI | 2018-09-27 | 0.8899 | no_reprice | **HALT** |
| KWALITY | 2010-06-15 | 0.5833 | wrong_ratio | **HALT** |
| MENONBE | 2016-08-30 | 0.8333 | no_reprice | **HALT** |
| OMAXE | 2013-11-11 | 0.7959 | no_reprice | **HALT** |
| OSWALSEEDS | 2024-02-02 | 0.8333 | no_reprice | **HALT** |
| PRADIP | 2013-02-12 | 0.8333 | no_reprice | **HALT** |
| RADIOCITY | 2020-03-12 | 0.8000 | no_reprice | **HALT** |
| RAIREKMOH | 2015-03-16 | 0.8571 | no_reprice | **HALT** |
| SADHNANIQ | 2023-07-05 | 0.8182 | no_reprice | **HALT** |
| SAHPETRO | 2013-07-09 | 0.4524 | wrong_ratio | **HALT** |
| STAMPEDE | 2017-01-10 | 0.8000 | no_reprice | **HALT** |
| TTML | 2013-08-07 | 0.8824 | no_reprice | **HALT** |
...
| 7 | ISIN-merge splices | B | `7c42a0c` | **YES** | 551 splice fabrications re-appeared, worst: PATANJALI RUCHISOYA->PATANJALI ret=+30923.9% |
