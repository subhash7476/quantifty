...
**Script-generated** — `scripts/psb1/certify_substrate.py`. Code commit `9a02f9b`.
...
| Check | Result | Detail |
|---|:--:|---|
| **Arm A** intra-symbol CA-shape | **HALT** | 83 residue (78 dispositioned, **5** undocumented); 2733 large_genuine |
...
Large genuine moves (|ret|>=40%, non-CA-shaped, not CA-explained): **2733** — disclosed for operator review, not HALT.
