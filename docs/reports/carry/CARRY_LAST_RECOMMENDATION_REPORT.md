...
**Script-generated** — `scripts/carry_last_recommendation_report.py`. Code commit `2afaad8`.

**Generated:** 2026-08-25

**Formation (recommendation):** 2026-07-31  ·  **Marked through:** 2026-08-24 (latest bhavcopy)
...
Window: **2026-07-31 → 2026-08-24** (17 trading days). Equal-weight near-month futures returns, gross of fees.


| Book | n | Coverage | Mean return |
|---|--:|:--:|--:|
| **Long (Q5)** | 41 | 41/41 | -0.0108%
| **Short (Q1)** | 41 | 41/41 | +0.2525%
| **Spread (L−S)** | — | — | **-0.2633%**

Benchmark: **Nifty 50 -0.67%** over the same window — the carry spread outperformed the benchmark by **+0.4115%** (relative to a flat index the spread was -0.2633%).

Fees: entry recorded by the paper run = ₹3,270 fees + ₹5,000 slippage (~4.1 bp on ₹20M gross); a symmetric exit makes ~8.3 bp round-trip → net spread ≈ **-0.3463%**.
...
| Side | Helped | Hurt |
|---|---|---|
| Long | ETERNAL +7.9%, MOTHERSON +10.6%, MOTILALOFS +16.4% | LUPIN -10.2%, BHARATFORG -7.5%, IEX -7.3% |
| Short | GODREJCP -13.2%, RECLTD -12.1%, BLUESTARCO -10.4% | BDL +10.6%, JUBLFOOD +16.3%, BOSCHLTD +17.5% |
