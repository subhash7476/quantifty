...
| Build-time substrate — **PINNED at A2 build (Prompt 8; corrected Prompt 9, 2026-07-12)** | store SHA-256 **`e51363ea9681fda72120964b483b70daed34ea64e395bd098fc5cb3a6aad5e72`**; **code commit `98bcaf2f18d5120f1579a29ec553dc5c8266ed23`** — the commit that *contains* the harness (Prompt-9 F1: the earlier `42797043` pin was false — code-less). The A2 record identity is **content-addressed** by git-normalized source hashes (HEAD-independent, CRLF/LF-immune): `model.py` `db06ceffd9e4fded…`, `validation.py` `865775210a1eecc3…`, `void_precondition.py` `54305a0f42340091…`, `run_a2_validation.py` `c218c47bfcf78e21…`, `phase1_prereg_analysis.py` `bf9879fb7b3a3bd1…`. Library versions (Python 3.13.5 / duckdb 1.4.3 / numpy 2.4.4 / scipy 1.17.0 / pandas 2.3.3) are recorded provenance, **not** part of the identity. Full values in the A2 record `docs/reports/csmp_a2_records/`. |
