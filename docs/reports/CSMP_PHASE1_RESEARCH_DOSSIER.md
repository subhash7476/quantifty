...
| Build-time substrate — **PINNED at A2 build (Prompt 8; corrected Prompt 9; re-pinned Prompt 11, 2026-07-12)** | store SHA-256 **`e51363ea9681fda72120964b483b70daed34ea64e395bd098fc5cb3a6aad5e72`**; **code commit `8889e70defa8e00bd6ec810825f4dd6b8ff4ae31`** — the commit that *contains* the harness (Prompt-11 parameterized the report generator + added the `n==42` grid guard; the identity legitimately changed because content changed). Dev **`validation_id` `65cefc3704e87092c6e9d207e755a1bbb7646708ad0502d1282feef063825f63`** (Prompt-10 Step-0 tripwire). The A2 record identity is **content-addressed** by git-normalized source hashes (HEAD-independent, CRLF/LF-immune): `model.py` `db06ceffd9e4fded…`, `validation.py` `b2b84a8e233a5c39…`, `void_precondition.py` `54305a0f42340091…`, `run_a2_validation.py` `d07e419dc053786f…`, `phase1_prereg_analysis.py` `bf9879fb7b3a3bd1…`. Library versions (Python 3.13.5 / duckdb 1.4.3 / numpy 2.4.4 / scipy 1.17.0 / pandas 2.3.3) are recorded provenance, **not** part of the identity. `results.json` is byte-identical to the prior `d0651e10` record — the reporting fix moved no number. Full values in the A2 record `docs/reports/csmp_a2_records/`. |
