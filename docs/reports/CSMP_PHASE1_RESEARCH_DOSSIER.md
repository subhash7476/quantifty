...
| Build-time substrate — **PINNED at A2 build (Prompt 8, 2026-07-12)** | Python **3.13.5**, duckdb **1.4.3**, numpy **2.4.4**, scipy **1.17.0**, pandas **2.3.3**; store SHA-256 **`e51363ea9681fda72120964b483b70daed34ea64e395bd098fc5cb3a6aad5e72`**; code commit **`42797043fb0706a86d1442eadd315cc21f339345`**. (Recorded in the A2 validation record `docs/reports/csmp_a2_records/`.) |
