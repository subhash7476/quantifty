...
| Build-time substrate — **PINNED at A2 build (Prompt 8; corrected Prompt 9; re-pinned Prompts 11–12, 2026-07-12)** | store SHA-256 **`e51363ea9681fda72120964b483b70daed34ea64e395bd098fc5cb3a6aad5e72`**; **code commit `983cca082eb3b00588844ac5d4b0d97185b692dd`** — the commit that *contains* the harness (Prompt-12 made sealedness data-derived + added the label/window cross-check; the identity legitimately changed because content changed). Dev **`validation_id` `a5c113dc8034ae76b0809042501d69715159d82a8b355b4b865806a5758198c6`** (Prompt-10 Step-0 tripwire). The A2 record identity is **content-addressed** by git-normalized source hashes (HEAD-independent, CRLF/LF-immune): `model.py` `db06ceffd9e4fded…`, `validation.py` `ee89aa3bee6c094d…`, `void_precondition.py` `54305a0f42340091…`, `run_a2_validation.py` `fcc6a7d02ce5597a…`, `phase1_prereg_analysis.py` `bf9879fb7b3a3bd1…`. Library versions (Python 3.13.5 / duckdb 1.4.3 / numpy 2.4.4 / scipy 1.17.0 / pandas 2.3.3) are recorded provenance, **not** part of the identity. `results.json` is byte-identical (`be662698…`) across the Prompt-9/11/12 re-pins — the guard/reporting fixes moved no number. Full values in the A2 record `docs/reports/csmp_a2_records/`. |
