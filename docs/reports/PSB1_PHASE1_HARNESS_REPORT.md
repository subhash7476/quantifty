...
**Script-generated** (protocol §10). Code commit at generation `07572e4` — when the report is committed together with the code this is the **parent** of the commit that adds this file (Lead Review D3); re-run post-commit to stamp the exact commit. Seed `20260713` (§10).
...
|---|---|---|
| S1/P6 determinism (two interpreters, PYTHONHASHSEED 0 vs 1, whole-file bytes) | sha256 seed0=d35a6f8bd6a73a40 seed1=d35a6f8bd6a73a40 | PASS |
