...
1. Disposition **G1's 5 remaining A1 dates** (`CARRY_G1_R4_VERIFICATION.md` §3): drop 2012-11-11 (Sunday artifact) from the calendar, extend `fill_gap_from_vendor()` to create absent files so 2013-10-09 can come from the operator CSV, and register 2014-03-19 / 2014-12-15 / 2016-06-20 as evidenced accepted absences. Then re-scope B2 to the vendor span actually supplied (§4).
